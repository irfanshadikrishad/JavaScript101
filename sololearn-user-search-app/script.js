...
form.addEventListener("submit", function (e) {
  ...
  fetch(`https://api.sololearn.repl.co/profile/${uid}`)
    .then((res) => res.json())
    .then((data) => {
      ...
      document.getElementById("badge").innerHTML =
        data.userDetails.badges[0].name;
      ...
      document.getElementById("createddate").innerHTML =
        data.userDetails.registerDate.slice(0, 10);
      ...
      if (data.userDetails.connectedAccounts[0].service == "StackOverflow") {
        ...
        data.userDetails.connectedAccounts[1].service == "StackOverflow"
      ) {
        document.getElementById("stackoverflow").style.display = "inline";
        document.getElementById("slink").href =
          data.userDetails.connectedAccounts[1].profileUrl;
      } else if (
        data.userDetails.connectedAccounts[2].service == "StackOverflow"
      ) {
        document.getElementById("stackoverflow").style.display = "inline";
        document.getElementById("slink").href =
          data.userDetails.connectedAccounts[2].profileUrl;
