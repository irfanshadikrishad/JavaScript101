...
function drivegenerate() {
  let confirmGLink = document
    .getElementById("drive")
    .value.includes("https://drive.google.com/file/d/");
  if (confirmGLink == true) {
    let refinedLink = document
      .getElementById("drive")
      .value.replace(
...
function audiogenerate() {
  let confirmALink = document
    .getElementById("audio")
    .value.includes("https://drive.google.com/file/d/");
  if (confirmALink == true) {
    const audio1 = '<audio width="300" height="32" controls="controls" src="';
    const audio2 = '" type="audio/mp3"></audio>';
    let refinedALink = document
      .getElementById("audio")
      .value.replace(
        "https://drive.google.com/file/d/",
        "https://drive.google.com/uc?export=download&id=",
      ...
      .replace("/view?usp=sharing", "");
    document.getElementById("copy-input-audio").value =
      `${audio1}${refinedALink}${audio2}`;
  } else {
    alert("Required Google Drive Share Link!");
  }
}
function videogenerate() {
  let confirmVLink = document
    .getElementById("video")
    .value.includes("https://drive.google.com/file/d/");
  if (confirmVLink == true) {
    const video1 = '<iframe src="';
    const video2 = '/preview" width="560" height="315"></iframe>';
    let refinedVLink = document
      .getElementById("video")
      .value.replace("/view?usp=sharing", "");
    document.getElementById("copy-input-video").value =
      `${video1}${refinedVLink}${video2}`;
  } else {
    alert("Required Google Drive Share Link!");
  }
}
...
function clickin() {
  ...
  document.getElementById("copy").innerHTML =
    '<i class="fa-regular fa-copy"></i> Copied!';
...
function clickinAudio() {
  ...
  document.getElementById("copy-audio").innerHTML =
    '<i class="fa-regular fa-copy"></i> Copied!';
...
function clickinVideo() {
  ...
  document.getElementById("copy-video").innerHTML =
    '<i class="fa-regular fa-copy"></i> Copied!';
